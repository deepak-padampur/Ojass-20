      ...
      <g id="our_mask">
        ...
        <div class="vcenter"  id="menu">
                <section class="section" >
                  ...
                  <div id="sec1" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;">
                  ...
                  <div id="sec2" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>
                    <?php
                  //  include'pages/page2.php';
                   ?>
                  </div>
                  <div id="sec3" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>
                    <?php
                  //  include'pages/page3.php';
                   ?>
                  </div>
                  <div id="sec4" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                  Team 4
                  </div>
                  <div id="sec5" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                  Team 5
                  </div>
                  <div id="sec6" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 6
                  </div>
                  <div id="sec7" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 7
                  </div>
                  <div id="sec8" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 8
                  </div>
                  <div id="sec9" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 9
                  </div>
                  <div id="sec10" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 10
                  </div>
                  <div id="sec11" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 11
                  </div>
                  <div id="sec12" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 12
                  </div>
                  <div id="sec13" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>

                    Team 13
                  </div>
                  <div id="sec14" style="display: none;width:900px;justify-content:center;margin:4% auto; height:0px;" >
                    <button class="back"><i style="font-size:28px;" class="fa fa-arrow-left" aria-hidden="true"></i></button>
